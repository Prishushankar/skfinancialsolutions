    ...
    <div className="w-full bg-gradient-to-b from-white to-gray-50 py-16 lg:py-24 font-poppins pt-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* WhatsApp Business */}
          <motion.div 
            className="bg-white p-6 rounded-xl shadow-md border border-gray-100 flex items-start cursor-pointer group"
            whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(0, 0, 0, 0.1)" }}
            transition={{ duration: 0.2 }}
            onClick={() => {
              const phoneNumber = "919199200558"; // Your WhatsApp Business number (without +)
              const message = encodeURIComponent("Hi! I'm interested in your financial services. Could you please help me?");
          ...
          >
            <div className="mr-4 bg-green-100 p-3 rounded-full group-hover:bg-green-200 transition-colors duration-200">
            ...
            <div>
              <h3 className="font-semibold text-lg text-text-primary mb-1 group-hover:text-green-600 transition-colors duration-200">WhatsApp Business</h3>
              <p className="text-text-secondary mb-1">+91 9199200558</p>
              <p className="text-green-600 text-sm font-medium">Click to chat instantly</p>
            </div>
          </motion.div>
        </motion.div>
